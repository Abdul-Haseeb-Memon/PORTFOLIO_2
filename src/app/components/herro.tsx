        ...
        <main className="w-full h-full  md:h-[500px] bg-white flex justify-center items-center max-w-screen-2xl mx-auto relative">
            ...
            <div className="w-full md:w-[100%] h-[80%] flex flex-col md:flex-row justify-evenly items-center md:items-start">
                ...
                <div className="w-[80%] md:w-[50%] space-y-5 md:space-y-2 lg:space-y-6 pb-8">
                  <h1 className="intro text-2xl md:text-3xl lg:text-4xl font-serif font-semibold relative">Hi, I&apos;m Abdul Haseeb Memon 👋</h1>
                 ...
                 <span className="flex items-center space-x-5 "><Link href={"https://github.com/Abdul-Haseeb-Memon"}><FiGithub className="text-gray-900 text-2xl md:text-3xl cursor-pointer transition-transform duration-500 hover:scale-105"/></Link><Link href={"#"}><FaLinkedin className="text-blue-700 text-2xl md:text-3xl cursor-pointer transition-transform duration-500 hover:scale-105"/></Link><Link href={"#"}><IoLogoYoutube className="text-red-500 text-2xl md:text-3xl cursor-pointer transition-transform duration-500 hover:scale-105"/></Link></span>
                 </div>
            </div>
        </main>
    )
